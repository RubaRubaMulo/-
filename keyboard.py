...
off_link = types.InlineKeyboardButton(text="🌍 Официальный сайт", url="t.me/soft_industry/") #https://eyeofgod.info/

facebook_link = types.InlineKeyboardButton(text="⛓ Facebook", url="t.me/soft_industry") #https://www.facebook.com/eyegodbot/
